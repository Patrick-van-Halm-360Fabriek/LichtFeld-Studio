...
namespace lfs::vis {
    ...
    struct VulkanViewportPass::Impl {
        ...
        void prepare(const VulkanViewportPassParams& params) {
            ...
            updateTexturedOverlayBuffer(params.textured_overlays, frame.textured_overlay);
            updateTexturedOverlayBuffer(params.ui_textured_overlays, frame.ui_textured_overlay);
        ...
        void recordTexturedOverlayPass(const ViewportRecordContext& ctx,
            ...
            auto& frame = resourcesForFrame(params.frame_slot);
            assert(resource.count > 0 && textured_overlay_pipeline != VK_NULL_HANDLE &&
